...
button[kind="secondary"]{{background:rgba(255,255,255,0.05) !important;color:rgba(255,255,255,0.45) !important;border:none !important;border-bottom:3px solid transparent !important;border-radius:4px 4px 0 0 !important;box-shadow:none !important;font-size:12px !important;font-weight:500 !important;font-family:'Noto Sans KR',sans-serif !important;padding:9px 4px !important;transition:all 0.15s !important;}}
button[kind="secondary"]:hover{{background:rgba(255,255,255,0.08) !important;color:rgba(255,255,255,0.85) !important;border-bottom:3px solid rgba(200,168,118,0.4) !important;box-shadow:none !important;}}
button[aria-label="{active_label}"]{{background:rgba(200,168,118,0.12) !important;color:#C8A876 !important;border:1px solid rgba(200,168,118,0.25) !important;border-bottom:3px solid #C8A876 !important;font-weight:700 !important;}}
button[kind="primary"]{{background:linear-gradient(135deg,#C8A876,#B8946A) !important;color:#0A0A0F !important;border:none !important;font-weight:700 !important;border-radius:8px !important;font-family:'Noto Sans KR',sans-serif !important;}}
button[kind="primary"]:hover{{background:linear-gradient(135deg,#D9BA8A,#C8A876) !important;box-shadow:0 4px 18px rgba(200,168,118,0.3) !important;}}
[data-testid="stDownloadButton"] button{{background:linear-gradient(135deg,#22c55e,#16a34a) !important;color:#fff !important;border:none !important;font-weight:700 !important;border-radius:8px !important;}}
[data-testid="stTextInput"] input,[data-testid="stTextArea"] textarea,[data-testid="stNumberInput"] input{{background:#FFF !important;border:1.5px solid #D0D0D0 !important;border-radius:8px !important;color:#111 !important;font-size:14px !important;}}
[data-testid="stTextInput"] input:focus,[data-testid="stTextArea"] textarea:focus{{border-color:#C8A876 !important;box-shadow:0 0 0 2px rgba(200,168,118,0.2) !important;}}
[data-testid="stTextInput"] label,[data-testid="stTextArea"] label,[data-testid="stNumberInput"] label,[data-testid="stSelectbox"] label,[data-testid="stFileUploader"] label,[data-testid="stColorPicker"] label{{color:#E0E0E0 !important;font-size:13px !important;font-weight:600 !important;}}
[data-testid="stFileUploader"]{{background:rgba(255,255,255,0.04) !important;border:1.5px dashed rgba(200,168,118,0.4) !important;border-radius:10px !important;}}
[data-testid="stSelectbox"]>div>div{{background:#FFF !important;border:1.5px solid #D0D0D0 !important;border-radius:8px !important;color:#111 !important;}}
